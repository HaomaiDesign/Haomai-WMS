								...
								<?php if($_GET['target'] == 'out') {?>
									...
									<div class="row">
										...
										<div class="form-group">
											...
											<input type="text" name="businessName" id="businessName" onchange="update('<?php echo $_SESSION['form']['table'];?>','<?php echo $_SESSION['form']['server']['id'];?>','businessName','1')" class="form-control" value="<?php if (isset($_SESSION['form']['server']['businessName'])) echo $_SESSION['form']['server']['businessName']; ?>" <?php if($_SESSION["user"]["roleId"] == 2) {echo "readonly";} ?>>
										...
										<div class="form-group">
											...
											<input type="text" name="taxId" id="taxId" onchange="update('<?php echo $_SESSION['form']['table'];?>','<?php echo $_SESSION['form']['server']['id'];?>','taxId','1')" class="form-control" value="<?php if (isset($_SESSION['form']['server']['taxId'])) echo $_SESSION['form']['server']['taxId']; ?>" <?php if($_SESSION["user"]["roleId"] == 2) echo " readonly"; ?>>
										...
										<div class="form-group">
											...
											<input type="text" name="phone" id="phone" onchange="update('<?php echo $_SESSION['form']['table'];?>','<?php echo $_SESSION['form']['server']['id'];?>','phone','1')" class="form-control" value="<?php if (isset($_SESSION['form']['server']['phone'])) echo $_SESSION['form']['server']['phone']; ?>" <?php if($_SESSION["user"]["roleId"] == 2) echo " readonly"; ?>>
											<?php $_SESSION['form']['data'][]='phone'; $_SESSION['form']['type'][]='string'; $_SESSION['form']['quantity']++;?>
										</div>
										</div>
										<div class="col-sm-3 col-md-3">
										<div class="form-group">
											...
											<input type="text" name="whatsapp" id="whatsapp" onchange="update('<?php echo $_SESSION['form']['table'];?>','<?php echo $_SESSION['form']['server']['id'];?>','whatsapp','1')" class="form-control" value="<?php if (isset($_SESSION['form']['server']['whatsapp'])) echo $_SESSION['form']['server']['whatsapp']; ?>"<?php if($_SESSION["user"]["roleId"] == 2) echo " readonly"; ?>>
										...
										<div class="form-group">
											...
											<input type="text" name="wechat" id="wechat" onchange="update('<?php echo $_SESSION['form']['table'];?>','<?php echo $_SESSION['form']['server']['id'];?>','wechat','1')" class="form-control" value="<?php if (isset($_SESSION['form']['server']['wechat'])) echo $_SESSION['form']['server']['wechat']; ?>"<?php if($_SESSION["user"]["roleId"] == 2) echo " readonly"; ?>>
										...
										<div class="form-group">
											<label class="form-label"><?php echo $_SESSION['language']['Email'];?></label>
											<input type="email" name="email" id="email" onchange="update('<?php echo $_SESSION['form']['table'];?>','<?php echo $_SESSION['form']['server']['id'];?>','email','1')" class="form-control" value="<?php if (isset($_SESSION['form']['server']['email'])) echo $_SESSION['form']['server']['email']; ?>"<?php if($_SESSION["user"]["roleId"] == 2) echo " readonly"; ?>>
											<?php $_SESSION['form']['data'][]='email'; $_SESSION['form']['type'][]='string'; $_SESSION['form']['quantity']++;?>						
										</div>
										</div>
										<div class="col-sm-9 col-md-9">
										<div class="form-group">
											<label class="form-label"><?php echo $_SESSION['language']['Address'];?></label>
											<input type="text" name="address" id="address" onchange="update('<?php echo $_SESSION['form']['table'];?>','<?php echo $_SESSION['form']['server']['id'];?>','address','1')" class="form-control" value="<?php if (isset($_SESSION['form']['server']['address'])) echo $_SESSION['form']['server']['address']; ?>"<?php if($_SESSION["user"]["roleId"] == 2) echo " readonly"; ?>>
											<?php $_SESSION['form']['data'][]='address'; $_SESSION['form']['type'][]='string'; $_SESSION['form']['quantity']++;?>
										</div>
										</div>
										<div class="col-sm-3 col-md-3">
										<div class="form-group">
											<label class="form-label"><?php echo $_SESSION['language']['Postal Code'];?></label>
											<input type="text" name="postalCode" id="postalCode" onchange="update('<?php echo $_SESSION['form']['table'];?>','<?php echo $_SESSION['form']['server']['id'];?>','postalCode','1')" class="form-control" value="<?php if (isset($_SESSION['form']['server']['postalCode'])) echo $_SESSION['form']['server']['postalCode']; ?>"<?php if($_SESSION["user"]["roleId"] == 2) echo " readonly"; ?>>
											<?php $_SESSION['form']['data'][]='postalCode'; $_SESSION['form']['type'][]='string'; $_SESSION['form']['quantity']++;?>
										</div>
										</div>
										<div class="col-sm-4 col-md-4">
										<div class="form-group">
											<label class="form-label"><?php echo $_SESSION['language']['Location'];?></label>
											<input type="text" name="location" id="location" onchange="update('<?php echo $_SESSION['form']['table'];?>','<?php echo $_SESSION['form']['server']['id'];?>','location','1')" class="form-control" value="<?php if (isset($_SESSION['form']['server']['location'])) echo $_SESSION['form']['server']['location']; ?>"<?php if($_SESSION["user"]["roleId"] == 2) echo " readonly"; ?>>
											<?php $_SESSION['form']['data'][]='location'; $_SESSION['form']['type'][]='string'; $_SESSION['form']['quantity']++;?>
										</div>
										</div>
										<div class="col-sm-4 col-md-4">
										<div class="form-group">
											<label class="form-label"><?php echo $_SESSION['language']['Province / State'];?></label>
											<input type="text" name="province" id="province" onchange="update('<?php echo $_SESSION['form']['table'];?>','<?php echo $_SESSION['form']['server']['id'];?>','province','1')" class="form-control" value="<?php if (isset($_SESSION['form']['server']['province'])) echo $_SESSION['form']['server']['province']; ?>"<?php if($_SESSION["user"]["roleId"] == 2) echo " readonly"; ?>>
											<?php $_SESSION['form']['data'][]='province'; $_SESSION['form']['type'][]='string'; $_SESSION['form']['quantity']++;?>
										</div>
										</div>
										<div class="col-sm-4 col-md-4">
							...
							<div class="row">
								...
								<div class="col-12">
									<form onsubmit="sendBarcodeToUpdate()"  autocomplete="off" method="get">
										...
										<input type="hidden" id="inputActionId" name="action" class="form-control" value="addProductOut">
										<div class="row">
											<div class="col-">
												<label id="unitBarcodeTitleId" class="form-label"><?php echo $_SESSION['language']['Unit Barcode'];?></label>
											...
											<div class="col my-auto ml-4">
												<a href="printSaleOrder.php?target=out&businessId=<?php echo $_GET['businessId']; ?>&userId=<?php echo $_GET['userId']; ?>&date=<?php echo date('d-m-Y', strtotime($_GET['date'])); ?>&requestId=<?php echo $_GET['requestId']; ?>&orderId=<?php echo $_GET['id']; ?>" target="_blank"><i class="dropdown-icon fe fe-printer"></i></a>
											</div>
										</div>
									</form>
								</div>
								...
								<table id="table" class="table table-outline table-vcenter text-nowrap card-table">
								  ...
								  <tbody id="orderDetailsTableBody">
									...
									?>
										...
										<td class="text-center">
											<input <?php if($row['unitBarcode'] != "Special") echo "readonly";?> type='number' onchange="changeSpecialProdQuantity(<?= $row['orderId']?>,<?= $row['id']?>, this.value)" class='form-control' style='border: none; text-align: center;' value=<?php echo $row['quantity'];?> min=1 step=1>
										...
										<td>
											<div style="text-align:center">
												<?php if($row["unitBarcode"] == "Special") { ?>
													-
												<?php } else { ?>
													<button type="button" id="modifyDates" onclick="openModalDates('<?= $row['unitBarcode']; ?>', 'out', <?= $row['orderId']; ?>)" class="btn-success btn-sm"><i class="far fa-calendar"></i> </button>
												<?php } ?>
											</div>
										</td>
										<td>
			...
			<div id="modalDates" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
				<div class="modal-dialog">
					...
					<div class="modal-footer">
						<button id="closeModal" type="button" onclick="location.reload()" class="btn btn-default" data-dismiss="modal">Cerrar</button>
					</div>
...
if (confirm("Desea eliminar el producto")) {
    ...
    $.ajax({
        ...
        success: function(data) {
			...
			data = JSON.parse(data);	
			if(data["type"] == "success"){
				document.getElementById(`productRowDetailsId-${rowId}`).style.display = 'none';
			}
			console.log(data); // Inspect this in your console
        },
		error: function(data) { 
...
function changeLoteQty(loteId, orderId, flagInOut, dueDate, stock,available, oldQty, sku, name, name2, unitBarcode, image){
	...
	$.ajax({
		...
		success: function(data) {
			...
			productsParsed.forEach((prod) => {
				...
				`<tr>
					<td class='text-center'>
						<input id="loteQty${prod.id}" type='number' onchange="changeLoteQty(${prod.id},${orderId},'${flagInOut}','${prod.dueDate}',${prod.stock},${prod.available},${prod.quantity},'${prod.sku}','${prod.name}','${prod.name2}','${prod.unitBarcode}','${prod.image}')" class='form-control' style='border: none; text-align: center;' value="${prod.quantity}" min=${flagInOut == 'in' ? 1 : 0} max=${prod.available == null ? prod.stock : (prod.available + prod.quantity)} step=1 <?php if($_GET["roleId"] == 2) echo "readonly"; ?>>
					</td>
					${dueDate}
					${available}
					${showStock}
