...
<html lang="en">
    ...
    <body onload="window.print()">
					...
					<table class="table table-sm">
						<thead style="font-size: 10pt;">
							<tr>
								...
								<th style="width:15%;font-weight:bold; text-align: center;">Cajas</th>
								<th style="width:40%;font-weight:bold;">Descripcion</th>
								<th style="width:15%;font-weight:bold; text-align: center;">Unid./Caja</th>
								<th style="width:15%;font-weight:bold; text-align: center;">Unidades</th>
							...
							<?php
								...
								if ($stmtProduct) {
									...
									while ($row = mysqli_fetch_array($stmtProduct,MYSQLI_ASSOC)) {
										...
										$box = $row['quantity']/$row['pack'];

										echo "<tr>";
										//echo "<td style='text-align: center;'>" . $row["productSku"] ."</td>";
										echo "<td style='text-align: center;'>" . $row["code"] . "</td>";
										echo "<td style='text-align: center;'>" . number_format($box,2,",","."). "</td>";
										echo "<td>" . $row["productName"] . "</td>";
										echo "<td style='text-align: center;'>" . number_format($row['pack'],2,",",".") . "</td>";
										echo "<td style='text-align: center;'>" . number_format($row['quantity'],2,",",".") . "</td>";
										echo "</tr>";

										$totBox += $box;
										$totUnit += $row['quantity'];
				...
				<div class="card-body" style="padding: 10px; padding-left: 30px; font-size: 10pt;">
					<div class="row">		
						<div class="col">
							...
							<?php echo number_format($totBox,2,",","."); ?>
						</div>	
						<div class="col">
							<strong>Total de Unidades: </strong>
							<?php echo number_format($totUnit,2,",","."); ?>	   
						</div> 	                                         
					</div>
				</div>
			</div>
		...
		<p style="padding-left: 30px; font-size: 15pt;"><strong>HOJA DE RUTA - Fecha: </strong> <?php echo $_GET["date"]; ?></p>
						...
						<div class="container">
							<div class="card" style="border: 1px solid gray; border-radius: 10px;">
								<div class="card-body" style="margin: 0px; padding: 5px; padding-left: 30px; font-size: 10pt;">
									<strong>Numero de Pedido: </strong><?php echo $row['requestId']; ?>
								</div>
								<div class="card-body" style="margin: 0px; padding: 0px; font-size: 10pt;">
									<div class="row" >
									...
									<table class="table table-sm">
										<thead style="font-size: 10pt;">
											<tr>
												...
												<th style="width:10%;font-weight:bold; text-align: center;">Cajas</th>
												<th style="width:40%;font-weight:bold;">Descripcion</th>
												<th style="width:10%;font-weight:bold; text-align: center;">Unid./Caja</th>
												<th style="width:10%;font-weight:bold; text-align: center;">Unidades</th>
												<th style="width:10%;font-weight:bold; text-align: right;">Precio Unit.</th>
												<th style="width:10%;font-weight:bold; text-align: right;">Importe</th>
											</tr>
										</thead>
										<tbody style="font-size: 10pt; padding-top: 0px">
											<?php
												...
												if ($stmtProduct) {
													...
													while ($rowProd = mysqli_fetch_array($stmtProduct,MYSQLI_ASSOC)) {
														...
														if($rowProd["market"] == 1){
															$pack = $rowProd["pack"];
															$box = $rowProd["quantity"]/$rowProd["pack"];
														}
														...
														echo "<td style='text-align: center;'>" . number_format($rowProd["quantity"],2,",","."). "</td>";
