			...
			<?php $_SESSION['form']['quantity'] = -1;?>
              ...
              <form action="newUpdate.php<?php if ($_GET['formStatus']=='create') echo '?formStatus=create&table='.$_SESSION['form']['table'].'&target='.$_GET['target']; if ($_GET['formStatus']=='view') echo '?formStatus=edit&target='.$_GET['target'].'&table='.$_SESSION['form']['table'].'&id='.$_GET['id'];?>" method="post" enctype="multipart/form-data">
