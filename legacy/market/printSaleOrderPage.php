...
$sql2 = "(SELECT orderId, productName, productName2, unitBarcode, packBarcode, image, quantity, pack, currency, capacity, unit
                FROM orderDetails 
                WHERE orderId=" . $_GET['orderId'] . " AND unitBarcode = 'Special')
                UNION
                (SELECT orderId, productName, productName2, unitBarcode, packBarcode, image, SUM(quantity) AS quantity, pack, currency, capacity, unit 
                FROM orderDetails 
                WHERE orderId=" . $_GET['orderId'] . " AND unitBarcode != 'Special'
...
<body onload="preparePrint()">
    <div class="container">
        ...
        <!-- FOOTER -->
        <div class="container"
            style="padding-top:10px; position:fixed; background-color: white; bottom:0; font-size: 15pt; border: 1px solid gray; border-radius: 25px; width:100%; padding-inline:10px">
            <div class="row">
                <div class="col-12" style="padding-top: 10px; padding-left: 50px; padding-bottom: 30px;">
                    ...
                    <!-- <div class="row" style="padding: 2px; ">
                            <div class="col-12">
                                <strong>Total de Unidades de Todas las Caja: </strong>
                                <?php
