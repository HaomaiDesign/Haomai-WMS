					...
					$pageUrl = "market.php?tableStatus=view";
					...
					if ($_GET['market']=="retail")
					{
						if ($companyCondition!="") 
							if ($_GET['search']!="")
								$sqlPage.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.priceRetail!=0) AND ((product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%') OR (product.code LIKE '%".$_GET['search']."%') OR (product.sku LIKE '%".$_GET['search']."%')))";
							else
								$sqlPage.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.priceRetail!=0))";
						else
							if ($_GET['search']!="")
								$sqlPage.=" WHERE ((product.flagMarket=1) AND (product.priceRetail!=0) AND (product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%'))";
							else
					...
					if ($_GET['market']=="wholesale")
					{
						if ($companyCondition!="") 
							if ($_GET['search']!="")
								$sqlPage.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.priceWholesale!=0) AND ((product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%') OR (product.code LIKE '%".$_GET['search']."%') OR (product.sku LIKE '%".$_GET['search']."%')))";
							else
								$sqlPage.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.priceWholesale!=0))";
						else
							if ($_GET['search']!="")
								$sqlPage.=" WHERE ((product.flagMarket=1) AND (product.priceWholesale!=0) AND (product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%'))";
							else
					...
					if ($_GET['market']=="private")
					{
						if ($companyCondition!="") 
							if ($_GET['search']!="")
								$sqlPage.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.pricePrivate!=0) AND ((product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%') OR (product.code LIKE '%".$_GET['search']."%') OR (product.sku LIKE '%".$_GET['search']."%')))";
							else
								$sqlPage.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.pricePrivate!=0))";
						else
							if ($_GET['search']!="")
								$sqlPage.=" WHERE ((product.flagMarket=1) AND (product.pricePrivate!=0) AND (product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%'))";
							else
					...
					<div class="col-12">
							...
							<div class="card-header">
								<div class="tags">
								  ...
								  <span class="tag tag-success">
									<?php if ($_GET['market']=='retail') echo $_SESSION['language']['Retail']; if ($_GET['market']=='wholesale') echo $_SESSION['language']['Wholesale']; if ($_GET['market']=='private') echo $_SESSION['language']['Private']; ?>
								  </span>
								  
								<?php if ($_GET['companyId']!="") { ?>
								  <span class="tag tag-warning">
									<?php 
									$sqlCompany = "SELECT businessName FROM company WHERE id=".$_GET['companyId']; 
									$stmtCompany= mysqli_query( $conn, $sqlCompany); 
						
									if ( $stmtCompany ) {
									$rowCompany = mysqli_fetch_array( $stmtCompany, MYSQLI_ASSOC );  
									echo $rowCompany['businessName'];
									}
									?>
									<a href="market.php?tableStatus=view&market=<?php echo $_GET['market']; ?><?php if ($_GET['search']!="") echo "&search=".$_GET['search']; ?>&page=1" class="tag-addon"><i class="fe fe-x"></i></a>
								  </span>
								<?php } ?>
								...
								<?php if ($_GET['search']!="") { ?> 
								  <span class="tag">
									...
									<a href="market.php?tableStatus=view&market=<?php echo $_GET['market']; ?><?php if ($_GET['companyId']!="") echo "&companyId=".$_GET['companyId']; ?>&page=1" class="tag-addon"><i class="fe fe-x"></i></a>
								  </span>
								<?php } ?>  
								  </div>
						...
						<div class="card">
							...
							<div class="card-header">
								...
								<?php if ($_GET['tableStatus']=='view') echo $_SESSION['language']['Customer']; if ($_GET['formStatus']=='view') echo $_SESSION['language']['Edit Customer']; if ($_GET['formStatus']=='create') echo $_SESSION['language']['Create a new customer']; ?>
								</h3>
							  <div class="card-options">
								<a href="marketCart.php?tableStatus=view&target=<?php echo $_GET['target']; ?>"class="btn btn-success btn-sm"><font color="white"><i class="fe fe-shopping-cart mr-2"></i> <?php echo $_SESSION['language']['See Orders'];?></font></a> 
							  </div>	
								...
								<table class="table table-hover table-outline table-vcenter card-table">
								  <thead>
									<tr>
									  ...
									  <th style="width:25%;font-weight:bold;"><?php echo $_SESSION['language']['Description'];?></th>									  
								  ...
								  <tbody>
									...
									if ($_GET['target']=="purchase")
										$sqlTarget = "SELECT * FROM supplier WHERE id=".$_GET['supplierId'].";";
									...
									<tr>
									  ...
									  <td>
										<div><?php echo $rowTarget['code']; ?></div>
									  </td>
									   <td>
							...
							<div class="card-header">
								<div class="tags">
								  ...
								  <span class="tag<?php if ($_GET['market']=="wholesale") echo " tag-success"; ?>">
									<a href="market.php?tableStatus=view<?php echo "&market=wholesale"; if ($_GET['companyId']!="") echo "&companyId=".$_GET['companyId']; if ($_GET['customerId']!="") echo "&customerId=".$_GET['customerId']; if ($_GET['supplierId']!="") echo "&supplierId=".$_GET['supplierId']; if ($_GET['target']!="") echo "&target=".$_GET['target']; ?>&page=1" class="tag-addon"><?php echo $_SESSION['language']['Wholesale']; ?></a>
								  </span>
								  
								  <span class="tag<?php if ($_GET['market']=="retail") echo " tag-success"; ?>">
									<a href="market.php?tableStatus=view<?php echo "&market=retail"; if ($_GET['companyId']!="") echo "&companyId=".$_GET['companyId']; if ($_GET['customerId']!="") echo "&customerId=".$_GET['customerId']; if ($_GET['supplierId']!="") echo "&supplierId=".$_GET['supplierId']; if ($_GET['target']!="") echo "&target=".$_GET['target']; ?>&page=1" class="tag-addon"><?php echo $_SESSION['language']['Retail']; ?></a>
								  </span>
								...
								<?php if ($_GET['search']!="") { ?> 
								  <span class="tag tag-success">
									<?php echo $_GET['search']; ?> 
									<a href="market.php?tableStatus=view<?php echo $pageGet; ?>&page=1" class="tag-addon"><i class="fe fe-x"></i></a>
								  </span>
								<?php } ?>  
								  </div>
							...
							<div class="card-header">
								...
								<?php if ($_GET['tableStatus']=='view') echo $_SESSION['language']['Products List']; if ($_GET['formStatus']=='view') echo $_SESSION['language']['Edit product']; if ($_GET['formStatus']=='create') echo $_SESSION['language']['Create product']; ?>
									...
									if ($_GET['target']=="purchase") {
										...
										$sqlCompanyActive = "SELECT flagCompanyActive FROM company WHERE id=".$_GET['supplierId'].";";  
								...
								<table id="table" class="table table-outline table-vcenter text-nowrap card-table">
								  ...
								  <tbody>
									...
									if ($_GET['market']=="retail")
									{
										if ($companyCondition!="") 
											if ($_GET['search']!="")
												$sql.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.priceRetail!=0) AND ((product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%') OR (product.code LIKE '%".$_GET['search']."%') OR (product.sku LIKE '%".$_GET['search']."%')))";
											else
												$sql.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.priceRetail!=0))";
										else
											if ($_GET['search']!="")
												$sql.=" WHERE ((product.flagMarket=1) AND (product.priceRetail!=0) AND (product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%'))";
											else
									...
									if ($_GET['market']=="wholesale")
									{
										if ($companyCondition!="") 
											if ($_GET['search']!="")
												$sql.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.priceWholesale!=0) AND ((product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%') OR (product.code LIKE '%".$_GET['search']."%') OR (product.sku LIKE '%".$_GET['search']."%')))";
											else
												$sql.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.priceWholesale!=0))";
										else
											if ($_GET['search']!="")
												$sql.=" WHERE ((product.flagMarket=1) AND (product.priceWholesale!=0) AND (product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%'))";
											else
									...
									if ($_GET['market']=="private")
									{
										if ($companyCondition!="") 
											if ($_GET['search']!="")
												$sql.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.pricePrivate!=0) AND ((product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%') OR (product.code LIKE '%".$_GET['search']."%') OR (product.sku LIKE '%".$_GET['search']."%')))";
											else
												$sql.=" WHERE ((product.flagMarket=1) AND (product.companyId=".$companyCondition.") AND (product.pricePrivate!=0))";
										else
											if ($_GET['search']!="")
												$sql.=" WHERE ((product.flagMarket=1) AND (product.pricePrivate!=0) AND (product.name LIKE '%".$_GET['search']."%') OR (company.businessName LIKE '%".$_GET['search']."%'))";
											else
									...
									<tr>
									  ...
									  <td class="text-center">
										<input id="<?php echo $row['id'];?>" type="number" class="form-control" style="padding: 0px; border: none; text-align: center;" value=<?php if ($_GET['market']=="wholesale") echo number_format($row['packWholesale'],0,",","."); else echo "1";?> min=<?php if ($_GET['market']=="wholesale") echo number_format($row['packWholesale'],0,",","."); else echo "1";?> step=<?php if ($_GET['market']=="wholesale") echo number_format($row['packWholesale'],0,",","."); else echo "1";?>>
									  ...
									  <td class="text-center">
										...
										if ($_GET['market']=="private")
											$marketId=2;
										?>
										<a onclick="addCart(<?php echo "'".$marketId."','".$row['id']."','".$_SESSION['user']['id']."', '".$_GET['customerId']."', '".$_GET['supplierId']."', '".$row['name']."'"; ?>)" class="icon"><i class="fe fe-shopping-cart"></i></a>
									  </td>
									</tr>
									<?php }; ?>
								  </tbody>
...
<script>	
function addCart(market, productId, userId, customerId, supplierId, productName){							
...
var quantity = document.getElementById(productId).value;
    ...
    $.ajax({
        ...
        type: 'GET',
        data: {productId:productId, userId:userId, customerId:customerId, supplierId:supplierId, quantity:quantity, market:market, action:"add"},
        success: function(data) {
			toastr.options.positionClass = "toast-top-left";
			toastr.success("<?php echo $_SESSION['language']['Product added'];?>: "+quantity+" - "+productName);
