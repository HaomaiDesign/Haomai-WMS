					...
					if ($_GET['target']=="supplier") {
						...
						if ($_GET['search']!="")
							$sqlPage.=" WHERE companyId=".$_SESSION['user']['companyId']." AND flagActive=1 AND ((businessName LIKE '%".$_GET['search']."%') OR (address LIKE '%".$_GET['search']."%') OR (supplierCode LIKE '%".$_GET['search']."%') OR (id LIKE '%".$_GET['search']."%') OR (phone LIKE '%".$_GET['search']."%') OR (taxId LIKE '%".$_GET['search']."%'))";
						else
							$sqlPage.=" WHERE companyId=".$_SESSION['user']['companyId']." AND flagActive=1";
								...
								<table class="table table-hover table-outline table-vcenter text-truncate card-table">
								  ...
								  <tbody>
									...
									<tr>
									 ...
									 <td>
										<div data-toggle="tooltip" data-placement="top" title="<?php echo $row['code'].$row['companyCode'].$row['supplierCode']; ?>"><?php echo $row['code'].$row['companyCode'].$row['supplierCode']; ?></div>
									  </td>
									  <td>
									  ...
									  <td class="text-center">
										<div class="item-action dropdown">
										  ...
										  <div class="dropdown-menu dropdown-menu-right">
											...
											<a href="list.php?formStatus=view&page=<?php echo $_GET['page']; ?>&target=<?php echo $_GET['target'];  ?>&id=<?php echo $row['id']; ?>" class="dropdown-item"><i class="dropdown-icon fe fe-edit-2"></i> <?php echo $_SESSION['language']['Edit'];?> </a> 
											<a href="listUpdate.php?formStatus=delete&target=<?php echo $_GET['target']; ?>&table=<?php echo $table; ?>&id=<?php echo $row['id']; ?>" class="dropdown-item"><i class="dropdown-icon fe fe-user-minus"></i> <?php echo $_SESSION['language']['Delete'];?></a>
										  </div>
										</div>
									  </td>
									</tr>
