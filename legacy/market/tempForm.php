			...
			<div class="col-12">
				<div class="card">
					...
					<div class="card-options">
					  <?php if ($_GET['tableStatus']=='view') { echo "<a href='temp.php?formStatus=create' class='btn btn-icon btn-lg'><i class='fe fe-user-plus'></i></a>"; }?>
					</div>
				  </div>
			...
			<?php $_SESSION['form']['quantity'] = -1;?>
              ...
              <form action="tempUpdate.php<?php if ($_GET['formStatus']=='create') echo '?formStatus=create&tempId='.$_GET['tempId'];?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
					<div class="col-sm-4 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="businessName" class="form-control" value="<?php if (isset($_GET['businessName'])) echo $_GET['businessName']; ?>" required>
					...
					<div class="col-sm-3 col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="taxId" class="form-control" value="<?php if (isset($_GET['taxId'])) echo $_GET['taxId']; ?>">
                    ...
                    <div class="col-sm-3 col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="phone" class="form-control" value="<?php if (isset($_GET['phone'])) echo $_GET['phone']; ?>">
					...
					<div class="col-sm-3 col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="whatsapp" class="form-control" value="<?php if (isset($_GET['whatsapp'])) echo $_GET['whatsapp']; ?>">
					...
					<div class="col-sm-3 col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="wechat" class="form-control" value="<?php if (isset($_GET['wechat'])) echo $_GET['wechat']; ?>">
					...
					<div class="col-sm-9 col-md-9">
                      <div class="form-group">
                        ...
                        <input type="text" name="address" class="form-control" value="<?php if (isset($_GET['address'])) echo $_GET['address']; ?>">
                    ...
                    <div class="col-sm-4 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="location" class="form-control" value="<?php if (isset($_GET['location'])) echo $_GET['location']; ?>">
