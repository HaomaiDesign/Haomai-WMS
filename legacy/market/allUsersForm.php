			...
			<?php $_SESSION['form']['quantity'] = -1;?>
					...
					<div class="col-sm-6 col-md-6">
                      <div class="form-group">
                        ...
                        <select name="languageId" id="select-language" class="form-control custom-select">
                          <option value="1" data-data='{"image": "assets/images/flags/ar.svg"}' <?php if ($_SESSION['form']['server']['languageId']==1) echo 'selected'; ?>> English</option>
                          <option value="2" data-data='{"image": "assets/images/flags/de.svg"}' <?php if ($_SESSION['form']['server']['languageId']==2) echo 'selected'; ?>> Español</option>
                          <option value="3" data-data='{"image": "assets/images/flags/cn.svg"}' <?php if ($_SESSION['form']['server']['languageId']==3) echo 'selected'; ?>> 简体中文</option>
                        </select>
                ...
                <div class="card-footer text-right">
                  <button type="submit" class="btn btn-primary"><?php if ($_GET['formStatus']=='create') echo "Create profile"; if ($_GET['formStatus']=='view') echo "Update profile"; ?></button>
                </div>
				</form>
