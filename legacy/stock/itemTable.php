						...
						?>
							...
							<div class="card-header">
							  ...
							  <div class="card-options">
								...
								<button type="button" id="sendCompany" onclick="sendCompany(<?php echo "'".$_SESSION['user']['id']."', '".$rowCompany['businessId']."', '".$rowCompany['businessName']."'"; ?>)" class="btn btn-success btn-sm"><i class="fe fe-shopping-cart mr-2"></i> <?php echo $_SESSION['language']['Send order'];?></button> 
							  </div>
							</div>
							  ...
							  <div class="table-responsive">
								<table id="table" class="table table-hover table-outline table-vcenter text-nowrap card-table">
								   <thead>
									<tr>
									  <th onclick="sortTable(0)"  style="width:10%;font-weight:bold;"><i class="fas fa-sort"></i> <?php echo $_SESSION['language']['Code'];?></th>
									  <th onclick="sortTable(1)" style="width:10%;font-weight:bold;"><i class="fas fa-sort"></i> <?php echo $_SESSION['language']['Brand'];?></th>
									  <th onclick="sortTable(2)" style="width:30%;font-weight:bold;"><i class="fas fa-sort"></i> <?php echo $_SESSION['language']['Product Name'];?></th>
									  <th onclick="sortTable(4)" style="width:5%;font-weight:bold;"><i class="fas fa-sort"></i> <?php echo $_SESSION['language']['Pack'];?>Pack</th>
									  <th onclick="sortTable(5)" style="width:10%;font-weight:bold;"><i class="fas fa-sort"></i> <?php echo $_SESSION['language']['Stock'];?>Stock</th>
									  <th onclick="sortTable(6)" style="width:30%;font-weight:bold;"><i class="fas fa-sort"></i> <?php echo $_SESSION['language']['Description'];?></th>
								  ...
								  <tbody>
									...
									$sql = "SELECT * FROM stkItem WHERE businessId=".$_SESSION['user']['businessId']; 
									$stmt = mysqli_query( $conn, $sql);  
									...
									<tr>
									  ...
									  <td>
										...
										<div><a onclick="window.location.href='productsList.php?formStatus=view&id=<?php echo $row['id']; ?>'" style="cursor: pointer;"><?php echo $row['name']; ?></a></div>
									  </td>
									  ...
									  <td class="text-center">
										<div><?php echo $row['subcategory']; ?></div>
									  </td>
									  
									  <td class="text-center">
										<a onclick="addCart(<?php echo "'".$marketId."','".$row['id']."','".$_SESSION['user']['id']."', '".$row['name']."'"; ?>)" class="icon"><i class="fe fe-shopping-cart"></i></a>
									  </td>
									</tr>
									<?php }; ?>
							...
							<div class="card">
								...
								<div class="card-header">
									...
									<div class="card-options">
										...
										<button type="button" id="sendAll" onclick="sendAll(<?php echo "'".$_SESSION['user']['id']."'"; ?>)" class="btn btn-success btn-sm"<?php if ($total==0) echo " disabled"; ?>><i class="fe fe-shopping-cart mr-2"></i><?php echo $_SESSION['language']['Send all '];?></button> 
...
function sendCompany(userId, businessId, businessName){							
...
document.getElementById("removeCart").disabled = true;
    ...
    $.ajax({
        url: '../webservice/cart.php',
        type: 'GET',
        data: {userId:userId, businessId:businessId, action:"sendCompany"},
        success: function(data) {
...
document.getElementById("removeCart").disabled = true;
    ...
    $.ajax({
        url: '../webservice/cart.php',
        type: 'GET',
        data: {userId:userId, action:"sendAll"},
        success: function(data) {
