...
if ($_GET['accessCode']=='fsdnkflewrj89032nikljwf9823h42y49721nbiofj90n23u4i9fh293ueb1p92e8h1kjrn209rj2ieb92ej1o4be192iru8y324inr2394y1hoebn9128rhdjn230oirb29034je20orb293rj230erj298rj2890erjh2i7gdq9wdh8293') {
$username = 'gerente';
$password = '1234';
	...
	if ($_GET['login']=="")
		if(isset($_SESSION['user']['flagResetPassword']) && $_SESSION['user']['flagResetPassword'] == 1){
			...
			if ($_SESSION['user']['businessId']==0){
				...
				//ASIA - empleado y administrador
				if($_SESSION["user"]["roleId"] == 2 || $_SESSION["user"]["roleId"] == 1){
