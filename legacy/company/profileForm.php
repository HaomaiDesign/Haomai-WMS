			...
			<div class="col-lg-12">
              <form class="card" action="profileUpdate.php<?php if ($_GET['formStatus']=='create') echo '?formStatus=create'; if ($_GET['formStatus']=='view') echo '?formStatus=edit&id='.$_SESSION['user']['businessId'];?>" method="post" enctype="multipart/form-data">
				<div class="card-status card-status-left bg-blue"></div>
				<div class="card-header">
					<h3 class="card-title" style="font-weight:bold;"><?php echo $_SESSION['language']['Company Profile'];?></h3>
				</div>
                <div class="card-body">
                  <div class="row">
					...
					<div class="col-sm-3 col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="taxCondition" class="form-control" value="<?php if (isset($_SESSION['form']['server']['condition'])) echo $_SESSION['form']['server']['condition']; ?>">
						<?php $_SESSION['form']['data'][]='taxCondition'; $_SESSION['form']['type'][]='string'; $_SESSION['form']['quantity']++;?>						
                      </div>
                    </div>
					<div class="col-sm-3 col-md-3">
                      <div class="form-group">
