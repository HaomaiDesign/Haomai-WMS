					...
					<div class="card">
								...
								<div class="item-action">								
									...
									<form action="reportDueList.php" method="get" autocomplete="off" >
										...
										<div class="input-icon mb-3">		
											...
											<input id="search" name="search" type="search" class="form-control header-search" value="" placeholder="<?php echo $_SESSION['language']['Date'];?>" autofocus>
						...
						<div class="card-header">
								<h3 class="card-title" style="font-weight:bold;">
									...
									<!-- &nbsp &nbsp <a target="_blank" href="printExpired.php?search=<?php if ($_GET["search"]!="") echo $_GET["search"]; else echo "30";?>"><i class="dropdown-icon fe fe-printer"></i></a> -->
								</h3>

								<div class="item-action">
									<a target="_blank" style="margin-left:20px;" href="printExpired.php?search=<?php if ($_GET["search"] != "") echo $_GET["search"]; else echo "30";?>"><i class="dropdown-icon fe fe-printer"></i></a>
									<a target="_blank" style="margin-left:15px;" href="exportExcelExpired.php?search=<?php if($_GET["search"] != "") echo $_GET["search"]; else echo "30";?>"><i class="dropdown-icon fe fe-log-out"></i></a>
								</div>
								  ...
								  <tbody>
									...
									<tr id="tableRow<?php echo $row['id'];?>">
										...
										<td>
											...
											<?php if ($_SESSION['user']['roleId'] != 2) {?>
												<div><?php if (strlen($row['name'])>70) echo substr($row['name'],0,70)."..."; else echo $row['name']; ?></div>
											<?php } else {?>
