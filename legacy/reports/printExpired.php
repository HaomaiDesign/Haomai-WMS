...
<style type="text/css">
  ...
  td    { page-break-inside:avoid; page-break-after:auto; vertical-align: middle !important; }
				...
				<div class="card-body" style="padding: 10px; padding-bottom: 0px;">
					<div class="row">				
						<div class="col" style="text-align: center; padding: 25px;">
							...
							<strong>RESUMEN DE PRODUCTOS VENCIDOS</strong><br>
						...
						-->	
							...
							<tbody style="font-size: 10pt; ">
								...
								<?php
									...
									$sql1 = "SELECT a.dueDate,a.id, a.unitBarcode, a.name, a.image, a.category, a.packWholesale, a.capacity, a.unit,  a.flagActive, SUM(b.stock) AS stock
									...
									<tr id="tableRow<?php echo $row['id'];?>">
										...
										<td class="text-center">
											<img src="<?php echo $row['image']; ?>" alt="Imagen del producto" style="width: 100px; height: 100px;">
										</td>
										<td class="text-center">
											<div style="color: red;">
												<strong>
										...
										<td class="text-center">                                                                                      
											<strong><div><?php if ($row['stock']!="") echo $row['stock']; else echo "0.00";?></div>  </strong>                           
										</td>
										<td>
