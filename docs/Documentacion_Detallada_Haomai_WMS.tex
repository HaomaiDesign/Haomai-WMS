...
\begin{itemize}
  \item \textbf{Lenguaje principal:} NestJS + NextJS
  \item \textbf{Frameworks/librerías:} TailwindCSS
  \item \textbf{Base de datos:} SQLServer
...
\begin{itemize}
  \item El contenedor web utiliza NextJS.
  \item El contenedor db utiliza SQLServer y persiste datos en un volumen.
